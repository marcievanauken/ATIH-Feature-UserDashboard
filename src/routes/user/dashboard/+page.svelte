...
<Navbar>
	<NavBrand href="/">
		<div class="self-center whitespace-nowrap text-xl font-semibold dark:text-white">
			Opportunity Matcher - User Dashboard
		</div>
	</NavBrand>
	<NavHamburger />
	<NavUl>
...
<!-- NOTE: "Mock" authentication handling - current assumption is if there is an errorMessage, user is not signed in -->
<!-- TODO: Handle sign in / authentication -->
{#if !signedIn}
